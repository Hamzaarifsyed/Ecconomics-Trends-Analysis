...
def generate_correlation_heatmaps(dataframes_dict_transpose, countries):
    ...
    for country in countries:
        ...
        categories_name = ['urban population','rural population','inflation','GDP Growth']
...
if __name__ == "__main__":
    file_paths = ['urban population.csv','rural population.csv','inflation.csv','GDP Growth.csv']
    selected_countries = ['Canada', 'China', 'United Kingdom', 'India']
    start_year = 2010
    end_year = 2022
    ...
    create_line_plot(dataframes_dict_transpose["rural_population"], title ="rural population")
    create_line_plot(dataframes_dict_transpose["inflation"], title ="inflation")
    ...
    df_names = ['urban_population','rural_population','inflation','GDP_Growth']
    dataframes = {
